...
enum class Errors
{
  ...
  invalid_initializer_list_row_count, ///< Initializer list has incorrect number of rows
  invalid_initializer_list_col_count, ///< Initializer list has incorrect number of columns
