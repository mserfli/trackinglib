...
/// Covariance matrixes are always symmetric and positive semi-definite.
///
/// Key properties:
...
class CovarianceMatrixFull
    : public SquareMatrix<ValueType_, Size_, true>
    , public contract::CovarianceMatrixIntf<CovarianceMatrixFull<ValueType_, Size_>>
{
public:
  using BaseSquareMatrix = SquareMatrix<ValueType_, Size_, true>; ///< type of the parent class
  ...
  /// \brief Construct a new Covariance Matrix Full<ValueType_, Size_> object
  ...
  /// \brief Move construct a new Covariance Matrix Full<ValueType_, Size_> object
  /// \param[in] other A base class object
  ...
  /// \brief Construct a new Covariance Matrix Full<ValueType_, Size_> object from a transposed SquareMatrix
  ...
  /// \brief Move construct a new Covariance Matrix Full<ValueType_, Size_> object from a transposed SquareMatrix
  /// \param[in] other A transposed base class object
  ...
  static auto FromDiagonal(const DiagonalMatrix<ValueType_, Size_>& diag) -> CovarianceMatrixFull;
  ...
  auto determinant() const -> ValueType_ { return BaseSquareMatrix::determinant(); }
  ...
  /// This method is numerically stable for positive definite matrixes.
  ///
