...
TEST(Rank1Update, ldl_downdate)
{
  ...
  tracking::math::TriangularMatrix<double, 4, true> expL(
    {{1.000000000000000,                  0,                  0,                  0},
     {0.826906272810916,  1.000000000000000,                  0,                  0},
     {0.368408400708721, -0.170649556577636,  1.000000000000000,                  0},
     {0.957565680065953, -1.241653442258710,  0.012564677932757,  1.000000000000000}});
...
TEST(Rank1Update, ldl_downdate_belowEpsilon)
{
  ...
  tracking::math::TriangularMatrix<double, 4, true> expL(
    {{1.000000000000000,                  0,                  0,                  0},
     {0.810207936706143,  1.000000000000000,                  0,                  0},
     {0.363324722972246, -0.006616609202130,  1.000000000000000,                  0},
     {0.981408181168445, -1.305936244332181, -0.042468692424681,  1.000000000000000}});
