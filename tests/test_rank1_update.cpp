...
TEST(Rank1Update, ldl_downdate_belowEpsilon)
{
  ...
  tracking::math::TriangularMatrix<double, 4, true> expL(
    {{1.000000000000000,                  0,                  0,                  0},
     {1.117144553721806,  1.000000000000000,                  0,                  0},
     {0.456769173763076, -1.870378532677203,  1.000000000000000,                  0},
     {0.543152741604088, -0.575547375780341,  0.434181260080981,  1.000000000000000}});

  tracking::math::DiagonalMatrix<double, 4> expD(
    {1.702895413761838e+00, 2.425592532820294e-01, 1.212332547953753e+00, 2.746814709096479e-17});
