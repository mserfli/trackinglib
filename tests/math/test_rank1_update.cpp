...
{
  // clang-format off
  auto U = TriangularMatrix<float64, 4, false, true>::FromList({
  ...
  const auto expD = DiagonalMatrix<float64, 4>::FromList({
...
TEST(Rank1Update, ldl_update) // NOLINT
{
  ...
  const auto expL = TriangularMatrix<float64, 4, true, true>::FromList({
